...
import retrofit2.Response;
    ...
    public class PedidosDespachados extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            Call<List<Contact>> call = apiInterface.getContacts("https://frutagolosa.com/FrutaGolosaApp/AdmPedidosAppD.php?c=" + ciudad + "&k=111523&e=Fabricado");
                ...
                public void onResponse(Call<List<Contact>> call, Response<List<Contact>> response) {
                    ...
                    adapter.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            Intent c = new Intent(PedidosDespachados.this, DetallePedido.class);
