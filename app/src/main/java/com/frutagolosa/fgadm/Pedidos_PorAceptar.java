...
public class Pedidos_PorAceptar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Por Confirmar");
        apiInterface = ApiClient.getApiClient().create(ApiInterface.class);
        SharedPreferences preferences=getSharedPreferences("login", Context.MODE_PRIVATE);
        String ciudad=preferences.getString("claveus","No");
String estado="Por Confirmar";
        Call<List<Contact>> call = apiInterface.getContacts("https://frutagolosa.com/FrutaGolosaApp/AdmPedidosApp.php?c="+ciudad+"&k=111523&e="+estado);
            ...
            public void onResponse(Call<List<Contact>> call, Response<List<Contact>> response) {
                ...
                adapter.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent c= new Intent(Pedidos_PorAceptar.this, DetallePedido.class);
