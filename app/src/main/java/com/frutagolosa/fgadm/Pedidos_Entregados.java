...
public class Pedidos_Entregados extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<List<Contact>> call = apiInterface.getContacts("https://frutagolosa.com/FrutaGolosaApp/AdmPedidosApp.php?c="+ciudad+"&k=111523&e=Entregado");
            ...
            public void onResponse(Call<List<Contact>> call, Response<List<Contact>> response) {
                ...
                adapter.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent c= new Intent(Pedidos_Entregados.this, DetallePedido.class);
